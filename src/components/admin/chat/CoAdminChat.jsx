...
const CoAdminChat = () => {
  ...
  const [adminCoAdminRoom, setCoAdminCoAdminRoom] = useState();
  ...
  return (
    <>
      <div className={stylesAdmin.CoAdminChatWrapper}>
        ...
        {reply && (
          <div className={stylesAdmin.ReplyContainer}>
            <div className={stylesAdmin.replyInfo}>
              {userData._id === reply.sender ? <h3>You</h3> : <h3>CoAdmin</h3>}
