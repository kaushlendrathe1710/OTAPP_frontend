...
const GroupInfo = ({ setToggleInfo, toggleInfo, singleGroupInfo, groupType }) => {
                    ...
                    <table>
                        <tbody>
                            ...
                            {groupType === "Student Group" ? (
                                ...
                                <tr>
                                    <th>No. Of Participants</th>
                                    <td>{singleGroupInfo?.admins?.length + singleGroupInfo?.tutors?.length}</td>
                                </tr>
                            )}
                            <tr>
                                <th>Sub-Admins</th>
                            ...
                            {groupType === "Student Group" ? (
                                ...
                                <tr>
                                    <th>Tutors</th>
                                    <td>{singleGroupInfo?.tutors?.length}</td>
                                </tr>
                            )}
                            <tr>
                                <th>Sub-Admins & Co-Admins Names</th>
                            ...
                            <tr>
                                {groupType === "Student Group" ? (
                                    ...
                                    <>
                                        <th>Tutors Names</th>
                                        <td>
                                            {singleGroupInfo?.tutors?.map((item, index) => {
                                                return (
                                                    <p key={item._id}>
                                                        {index <= 4 ? item.name : "..."}
                                                    </p>
                                            ...
                                            {singleGroupInfo?.tutors?.length > 5 && (
                                                <p className={styles.viewAll} onClick={() => handleOpenModal(singleGroupInfo?.students)}>
                                                    view all {singleGroupInfo?.tutors?.length} Participants
                                                </p>
                                            )}
                                        </td>
                                    </>
