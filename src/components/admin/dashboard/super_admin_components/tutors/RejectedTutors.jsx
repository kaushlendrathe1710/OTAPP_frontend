...
export const RejectedTutors = ({ isCoAdminComponent, isAdminComponent }) => {
  ...
  async function fetchTutors(page, limit) {
    const res = await api.get(
      `/tutor/get-all-rejected-tutorList-for-view?page=${page}&limit=${limit}`,
      {
        headers: {
  ...
  return (
    <div className="outletContainer">
      ...
      <h2 className={utilStyles.headingLg}>Rejected Tutors</h2>
