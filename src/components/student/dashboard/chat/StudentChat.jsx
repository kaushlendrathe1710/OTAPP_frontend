...
const StudentChat = () => {
  ...
  useEffect(() => {
    ...
    if (userData?._id) {
      getConversation(userData, setConversation, false);
    }
  }, [userData?._id]);
  ...
  const handleVideo = (studentAdminRoom) => {
    setAdminVideoId(studentAdminRoom);
    socket.emit("admin_student_video_join", studentAdminRoom);
    ...
    if (videoCall) {
      ...
      // console.log("On");
      socket.emit("videoCall", studentAdminRoom);
      localStorage.setItem("video", false);
      ...
      <div className={stylesStudent.StudentChatWrapper}>
        <div className={stylesStudent.WrapperHeader}>
          <div className={stylesStudent.adminContainer}>
            <img
              className={stylesStudent.adminImage}
              src={userdefault}
              alt="admin"
            />
            <div>
          ...
          <div className={stylesStudent.CommunicationContainer}>
            <BsFillCameraVideoFill
              className={stylesStudent.Icons}
              onClick={() => handleVideo(studentAdminRoom)}
              id={adminVideoId}
            />
        ...
        {videoCall === true ? (
          ...
          <div
            ...
            className={stylesStudent.mainChatContainer}
          >
            {messages.length !== 0 &&
              messages?.map((msg) => {
                return (
              ...
              {attachmentFiles.length !== 0 &&
                attachmentFiles?.map((file, i) => {
                  return (
                    <div
                      key={i}
                      className={`${stylesStudent.smallItemBoxPreview} ${
        ...
        {reply && (
          <div className={stylesStudent.ReplyContainer}>
