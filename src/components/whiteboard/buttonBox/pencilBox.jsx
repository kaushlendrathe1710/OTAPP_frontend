...
const PencilBox = ({ selectedBtn, setSelectedBtn, selectedStrokeSize, setSelectedStrokeSize }) => {
    ...
    return (
        <ButtonBoxLayout>
            <ActionButton buttonName={BUTTONS.DRAW.PENCIL} onClick={pencilClickHandler} selectedBtn={selectedBtn}>
                <TbPencil />
            </ActionButton>
            <ActionButton buttonName={BUTTONS.DRAW.HIGHLIGHTER} onClick={highlighterClickHandler} selectedBtn={selectedBtn}>
                <RiMarkPenLine />
            </ActionButton>
            <ActionButton buttonName={STROKE_SIZES.STROKE_THIN} onClick={strokeThinClickHandler} selectedBtn={selectedStrokeSize}>
                <MdOutlineShowChart size={"0.8em"} />
            </ActionButton>
            <ActionButton buttonName={STROKE_SIZES.STROKE_MID} onClick={strokeMidClickHandler} selectedBtn={selectedStrokeSize}>
                <MdOutlineShowChart size={"1em"} />
            </ActionButton>
            <ActionButton buttonName={STROKE_SIZES.STROKE_THICK} onClick={strokeThickClickHandler} selectedBtn={selectedStrokeSize}>
