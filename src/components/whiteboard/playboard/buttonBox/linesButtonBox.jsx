...
const LinesButtonBox = ({ selectedBtn, setSelectedBtn }) => {
    ...
    return (
        <ButtonBoxLayout>
            ...
            <ActionButton
                onClick={lineClickHanlder}
                buttonName={BUTTONS.LINE.SIMPLE}
            ...
            <ActionButton
                onClick={oneArrowClickHanlder}
                buttonName={BUTTONS.LINE.ONE_ARROW}
                selectedBtn={selectedBtn}
            >
                <BsArrowUpRight />
            </ActionButton>
            ...
            <ActionButton
                onClick={twoArrowClickHanlder}
                buttonName={BUTTONS.LINE.TWO_ARROW}
                selectedBtn={selectedBtn}
            >
