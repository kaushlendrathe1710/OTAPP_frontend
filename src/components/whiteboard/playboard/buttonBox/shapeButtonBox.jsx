...
const ShapeButtonBox = ({ selectedBtn, setSelectedBtn }) => {
    ...
    return (
        <ButtonBoxLayout>
            <ActionButton
                onClick={circleClickHanlder}
                buttonName={BUTTONS.SHAPES.CIRCLE}
            ...
            <ActionButton
                onClick={rectangleClickHanlder}
                buttonName={BUTTONS.SHAPES.RECTANGLE}
                selectedBtn={selectedBtn}
            >
                <BiRectangle />
            </ActionButton>
            ...
            <ActionButton
                onClick={triangleClickHanlder}
                buttonName={BUTTONS.SHAPES.TRIANGLE}
                selectedBtn={selectedBtn}
            >
                <BsTriangle />
            </ActionButton>
            ...
            <ActionButton
                onClick={diamondClickHanlder}
                buttonName={BUTTONS.SHAPES.DIAMOND}
                selectedBtn={selectedBtn}
            >
                <BsDiamond />
            </ActionButton>
            ...
            <ActionButton
                onClick={hexagonClickHanlder}
                buttonName={BUTTONS.SHAPES.HEXAGON}
                selectedBtn={selectedBtn}
            >
                <BsHexagon />
            </ActionButton>
