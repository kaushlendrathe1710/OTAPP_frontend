...
const ButtonBox = ({
  ...
  function moveButtonBoxHandler(e) {
    console.log("fjdl", e);
    if (isGrabbed) {
      let cx = e.nativeEvent.screenX;
      let cy = e.nativeEvent.screenY;
      ...
      btnBox.style.left = cx - 300 + "px";
      btnBox.style.top = cy - 580 + "px";
      // btnBox.style.left = (cx + 20) + 'px';
      // btnBox.style.top = (cy + 20) + 'px';
    }
  }
