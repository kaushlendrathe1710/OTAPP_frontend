...
import VideoIcon from "../../assets/assests/video.svg";
import { io } from "socket.io-client";
import VideoOff from "../../assets/assests/video-off.svg";
import MicWhite from "../../assets/assests/mic-white.svg";
import MicOff from "../../assets/assests/mic-off-line.svg";

// import Profile from "../../assets/assests/profile.svg";
import Msg_Illus from "../../assets/assests/msg_illus.svg";
import Msg from "../../assets/assests/msg.svg";
import ScreenShare from "../../assets/assests/share_screen.svg";
      ...
      {stream ? (
        ...
        >
          <div style={{ height: "2rem" }}>
            <h3>{myVdoStatus && userData.name}</h3>
          </div>
          ...
          <div className="iconsDiv">
            ...
            <div className="icons" onClick={() => updateMic()} tabIndex="0">
              {myMicStatus ? (
                <img src={MicWhite} alt="video on icon" />
              ) : (
            ...
            {/* <Modal title="Chat" footer={null} visible={isModalVisible} onOk={() => showModal(false)} onCancel={() => showModal(false)} style={{ maxHeight: "100px" }}>
                            {chat.length ? (
                                <div className="msg_flex">
                                    {chat.map((msg) => (
                                        <div className={msg.type === "sent" ? "msg_sent" : "msg_rcv"}>{msg.msg}</div>
                                    ))}
